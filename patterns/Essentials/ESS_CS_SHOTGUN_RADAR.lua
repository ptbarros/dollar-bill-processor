--[[
Pattern: ESS_CS_SHOTGUN_RADAR
DisplayName: CS-Shotgun Radar
Description: A radar with exactly 3 of 4 mirror pairs matching. The non-matching pair must have different digits (not a CS-Pair). The 3 matching pairs must use at least 2 distinct digit values.  |  Green Guide: CS-1340 (CS-Shotgun Radar)
BookRef: CS-1340
Tier: 2
