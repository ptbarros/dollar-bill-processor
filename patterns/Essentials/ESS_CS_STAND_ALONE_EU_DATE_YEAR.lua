--[[
Pattern: ESS_CS_STAND_ALONE_EU_DATE_YEAR
DisplayName: CS-Stand Alone EU Date Year
Description: A 6-digit ddmmyy block (EU format) surrounded by zeros. yy>=30 maps to 1900+yy, yy<30 maps to 2000+yy.  |  Green Guide: CS-1840 (CS-Stand Alone EU Date Year)
BookRef: CS-1840
Tier: 7
