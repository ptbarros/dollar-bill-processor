--[[
Pattern: ESS_CS_TETRADIC
DisplayName: CS-Tetradic
Description: Only digits 0, 1, 8; is a palindrome; AND reads the same upside-down (flipped 180°). Only ~2 exist per run.  |  Green Guide: CS-1160 (CS-Tetradic)
BookRef: CS-1160
Tier: 1
