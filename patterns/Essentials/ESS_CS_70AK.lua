...
Pattern: ESS_CS_70AK
DisplayName: CS-7OAK
Description: Seven of the same digit anywhere in the serial (one different digit somewhere), but not all seven in a row. Grouped version is CS-Seven (CS-500).  |  Green Guide: CS-490 (CS-7OAK)
BookRef: CS-490
Tier: 2
