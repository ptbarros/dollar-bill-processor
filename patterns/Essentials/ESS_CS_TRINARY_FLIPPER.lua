--[[
Pattern: ESS_CS_TRINARY_FLIPPER
DisplayName: CS-Trinary Flipper
Description: All 8 digits are from the flip set {0,1,6,8,9} and exactly 3 distinct digits are used. e.g., M 01810081 M.  |  Green Guide: CS-1060 (CS-Trinary Flipper)
BookRef: CS-1060
Tier: 7
