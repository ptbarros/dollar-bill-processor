--[[
Pattern: ESS_CS_US_DATE_NOTES
DisplayName: CS-US Date Notes
Description: Serial forms a valid US date (mmddyyyy) as a birthday — year within the last 100 years.  |  Green Guide: CS-520 (CS-US Date Notes)
BookRef: CS-520
Tier: 7
