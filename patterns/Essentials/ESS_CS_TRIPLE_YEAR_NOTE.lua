--[[
Pattern: ESS_CS_TRIPLE_YEAR_NOTE
DisplayName: CS-Triple Year Note
Description: Three overlapping valid years (default 1700-2099, editable below) starting at different positions among positions 1-5 in the serial.  |  Green Guide: CS-720 (CS-Triple Year Note)
BookRef: CS-720
Tier: 6
