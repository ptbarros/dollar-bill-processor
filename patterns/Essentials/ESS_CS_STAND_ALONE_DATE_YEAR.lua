--[[
Pattern: ESS_CS_STAND_ALONE_DATE_YEAR
DisplayName: CS-Stand Alone Date Year
Description: Catch-all: a 6-digit date block (mmddyy, ddmmyy, or yymmdd) surrounded by zeros. 2-digit year: yy>=30 maps to 1900+yy, yy<30 maps to 2000+yy.  |  Green Guide: CS-1820 (CS-Stand Alone Date Year)
BookRef: CS-1820
Tier: 7
