--[[
Pattern: ESS_CS_TRAILING_ZEROS
DisplayName: CS-Trailing Zeros
Description: Serial ends with one or more zeros, all zeros contiguous at the end. e.g., M xxxxxxx0 M or M xxxxx000 M. The more trailing zeros, the rarer.  |  Green Guide: CS-1960 (CS-Trailing Zeros)
BookRef: CS-1960
Tier: 7
