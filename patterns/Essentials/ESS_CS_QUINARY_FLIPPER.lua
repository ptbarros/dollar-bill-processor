--[[
Pattern: ESS_CS_QUINARY_FLIPPER
DisplayName: CS-Quinary Flipper
Description: All 8 digits are from the flip set {0,1,6,8,9} AND all five flip digits are present. The serial can be read upside down. e.g., M 01698900 M.  |  Green Guide: CS-1080 (CS-Quinary Flipper)
BookRef: CS-1080
Tier: 6
