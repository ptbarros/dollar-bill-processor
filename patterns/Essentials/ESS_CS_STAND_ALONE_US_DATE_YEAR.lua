--[[
Pattern: ESS_CS_STAND_ALONE_US_DATE_YEAR
DisplayName: CS-Stand Alone US Date Year
Description: A 6-digit mmddyy block (US format) surrounded by zeros. yy>=30 maps to 1900+yy, yy<30 maps to 2000+yy.  |  Green Guide: CS-1830 (CS-Stand Alone US Date Year)
BookRef: CS-1830
Tier: 7
