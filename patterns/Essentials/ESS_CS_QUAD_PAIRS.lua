--[[
Pattern: ESS_CS_QUAD_PAIRS
DisplayName: CS-Random Quad Pairs
Description: Four pairs of different digits spanning all 8 positions, with at least one pair having its two digits non-adjacent. A fully-grouped AABBCCDD arrangement qualifies as CS-Quad Pairs (CS-60) instead.  |  Green Guide: CS-70 (CS-Random Quad Pairs)
BookRef: CS-70
Tier: 6
