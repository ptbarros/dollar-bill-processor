--[[
Pattern: ESS_CS_INTL_HISTORY_NOTE
DisplayName: CS-INTL History Note
Description: Serial forms a valid INTL date (yyyymmdd) with year more than 100 years ago.  |  Green Guide: CS-640 (CS-INTL History Note)
BookRef: CS-640
Tier: 7
