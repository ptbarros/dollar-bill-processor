--[[
Pattern: ESS_CS_TRI_RADAR_BOOKEND
DisplayName: CS-Tri Radar Bookend
Description: First three digits mirror the last three in reverse (e.g., 123xx321). The three outer position-pairs are radar-matched: d[1]=d[8], d[2]=d[7], d[3]=d[6]. Not all three can be the same digit.  |  Green Guide: CS-1010 (CS-Tri Radar Bookend)
BookRef: CS-1010
Tier: 7
