--[[
Pattern: ESS_CS_TRIPLE_DOUBLE_DOUBLE
DisplayName: CS-Triple Double Double
Description: One CS-Triple (run of 3+) plus two CS-Pairs (runs of 2), all as consecutive groups.  |  Green Guide: CS-170 (CS-Triple Double Double)
BookRef: CS-170
Tier: 5
