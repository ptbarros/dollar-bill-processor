--[[
Pattern: ESS_CS_DUAL_RADAR_BOOKEND
DisplayName: CS-Dual Radar Bookend
Description: The first two digits are mirrored (reversed) at the end of the serial: A B xxxx B A, where A ≠ B. Distinguished from CS-Dual Repeater Bookend (CS-980) where the sequence repeats in the same order (A B xxxx A B). e.g., M 23xxxx32 M.  |  Green Guide: CS-970 (CS-Dual Radar Bookend)
BookRef: CS-970
Tier: 7
