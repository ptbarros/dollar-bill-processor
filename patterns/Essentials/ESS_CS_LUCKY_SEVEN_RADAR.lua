--[[
Pattern: ESS_CS_LUCKY_SEVEN_RADAR
DisplayName: CS-Lucky Seven Radar
Description: A CS-Quint or CS-50AK (5+ of same digit) within a CS-20AK (same different digit at both ends): e.g., 25555552. The outer digit bookends a run of 6 (or 5) identical inner digits.  |  Green Guide: CS-1350 (CS-Lucky Seven Radar)
BookRef: CS-1350
Tier: 2
