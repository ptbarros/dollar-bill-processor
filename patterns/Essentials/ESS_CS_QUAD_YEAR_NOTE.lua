--[[
Pattern: ESS_CS_QUAD_YEAR_NOTE
DisplayName: CS-Quad Year Note
Description: Four overlapping valid years (default 1700-2099, editable below) starting at different positions among positions 1-5 in the serial.  |  Green Guide: CS-730 (CS-Quad Year Note)
BookRef: CS-730
Tier: 5
Examples: ["11192010"]
--]]
