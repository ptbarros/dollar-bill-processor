--[[
Pattern: ESS_CS_UNARY_ROTATOR
DisplayName: CS-Unary Rotator
Description: Rotator using only 1 unique digit. Only 11111111 and 88888888 qualify (00000000 excluded as non-collectible).  |  Green Guide: CS-1100 (CS-Unary Rotator)
BookRef: CS-1100
Tier: 1
