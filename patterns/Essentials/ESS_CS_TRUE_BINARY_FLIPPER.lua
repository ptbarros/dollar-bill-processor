--[[
Pattern: ESS_CS_TRUE_BINARY_FLIPPER
DisplayName: CS-True Binary Flipper
Description: Only 0s and 1s (CS-True Binary), AND reads the same upside-down (CS-Flipper). Subset of both CS-900 and CS-Rotator.  |  Green Guide: CS-1040 (CS-True Binary Flipper)
BookRef: CS-1040
Tier: 1
