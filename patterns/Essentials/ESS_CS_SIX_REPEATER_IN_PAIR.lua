--[[
Pattern: ESS_CS_SIX_REPEATER_IN_PAIR
DisplayName: CS-Six Repeater in a Pair
Description: A 3-digit sequence repeated twice (6 digits) is bookended by a CS-2OAK: A · XYZ · XYZ · A, where A appears at positions 1 and 8 and differs from all of X, Y, Z. e.g., M 9 301 301 9 M.  |  Green Guide: CS-1510 (CS-Six Repeater in a Pair)
BookRef: CS-1510
Tier: 6
