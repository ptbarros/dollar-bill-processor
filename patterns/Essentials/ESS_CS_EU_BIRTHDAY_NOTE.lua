--[[
Pattern: ESS_CS_EU_BIRTHDAY_NOTE
DisplayName: CS-EU Birthday Note
Description: Serial forms a valid EU date (ddmmyyyy) as a birthday — year within the last 100 years.  |  Green Guide: CS-570 (CS-EU Birthday Note)
BookRef: CS-570
Tier: 7
