--[[
Pattern: ESS_CS_YEAR_NOTES
DisplayName: CS-Year Notes
Description: Catch-all: any serial containing a valid 4-digit year (default 1700-2099, editable below) as a consecutive block at any of the 5 possible positions.  |  Green Guide: CS-700 (CS-Year Notes)
BookRef: CS-700
Tier: 8
