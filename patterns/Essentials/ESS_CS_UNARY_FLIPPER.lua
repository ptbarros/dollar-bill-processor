--[[
Pattern: ESS_CS_UNARY_FLIPPER
DisplayName: CS-Unary Flipper
Description: All 8 digits are the same, and the digit is a valid flipper (1, 6, 8, or 9 — not 0). The note reads identically upside down. Also qualifies as CS-Solid (CS-500). The combination adds a significant premium.  |  Green Guide: CS-1030 (CS-Unary Flipper)
BookRef: CS-1030
Tier: 1
