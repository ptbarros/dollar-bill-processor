--[[
Pattern: ESS_CS_DUAL_BOOKEND
DisplayName: CS-Dual Matched Bookend
Description: The first two digits match the last two digits (same pair at each end). e.g., M 22xxxx22 M.  |  Green Guide: CS-960 (CS-Dual Matched Bookend)
BookRef: CS-960
Tier: 7
