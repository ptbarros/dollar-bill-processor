--[[
Pattern: ESS_CS_QUAD_FLIPPER
DisplayName: CS-Quad Flipper
Description: All 8 digits are from the flip set {0,1,6,8,9} and exactly 4 distinct digits are used. e.g., M 01899901 M.  |  Green Guide: CS-1070 (CS-Quad Flipper)
BookRef: CS-1070
Tier: 7
