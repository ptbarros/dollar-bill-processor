--[[
Pattern: ESS_CS_REVERSE_DATE_NOTES
DisplayName: CS-Reverse Date Notes
Description: The serial, when reversed, forms a valid calendar date in US (mmddyyyy), EU (ddmmyyyy), or INTL (yyyymmdd) format.  |  Green Guide: CS-510 (CS-Reverse Date Notes)
BookRef: CS-510
Tier: 9
