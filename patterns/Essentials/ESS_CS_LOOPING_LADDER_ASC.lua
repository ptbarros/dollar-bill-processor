--[[
Pattern: ESS_CS_LOOPING_LADDER_ASC
DisplayName: CS-Ascending Looping Ladder
Description: A cyclic rotation of 8 consecutive mod-10 digits in ascending order, where the sequence does not start at its natural first element (that would be CS-Ascending Ladder). e.g., M 78123456 M (digits 1-8 rotated to start at 7).  |  Green Guide: CS-1190 (CS-Ascending Looping Ladder)
BookRef: CS-1190
Tier: 1
