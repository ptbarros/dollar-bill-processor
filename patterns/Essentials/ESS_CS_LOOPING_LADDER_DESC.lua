--[[
Pattern: ESS_CS_LOOPING_LADDER_DESC
DisplayName: CS-Descending Looping Ladder
Description: A cyclic rotation of 8 consecutive mod-10 digits in descending order, where the sequence does not start at its natural first element (that would be CS-Descending Ladder). e.g., M 32987654 M (digits 2-9 rotated to start at 3).  |  Green Guide: CS-1200 (CS-Descending Looping Ladder)
BookRef: CS-1200
Tier: 1
