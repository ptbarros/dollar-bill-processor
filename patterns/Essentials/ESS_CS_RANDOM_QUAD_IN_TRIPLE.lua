--[[
Pattern: ESS_CS_RANDOM_QUAD_IN_TRIPLE
DisplayName: CS-Random Quad in Triple
Description: A CS-40AK (four of the same digit, scattered — no run of 4) coexists with three of a different digit and one random digit. Count distribution: {4, 3, 1}. e.g., M 34x44433 M.  |  Green Guide: CS-270 (CS-Random Quad in Triple)
BookRef: CS-270
Tier: 6
