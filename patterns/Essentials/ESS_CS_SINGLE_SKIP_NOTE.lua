--[[
Pattern: ESS_CS_SINGLE_SKIP_NOTE
DisplayName: CS-Single Skip Notes
Description: A CS-40AK that skips every other digit — the same digit at all 4 odd or all 4 even positions. The other 4 positions may not form another CS-40AK. e.g., M 1x1x1x1x M or M x2x2x2x2 M.  |  Green Guide: CS-1590 (CS-Single Skip Notes)
BookRef: CS-1590
Tier: 6
