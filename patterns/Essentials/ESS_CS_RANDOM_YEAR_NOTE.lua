--[[
Pattern: ESS_CS_RANDOM_YEAR_NOTE
DisplayName: CS-Random Year Note
Description: A valid 4-digit year (default 1700-2099, editable below) at any position, with the remaining 4 digits random (not all zeros and not 4OAK).  |  Green Guide: CS-690 (CS-Random Year Note)
BookRef: CS-690
Tier: 8
