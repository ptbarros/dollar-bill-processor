...
Pattern: ESS_CS_60AK
DisplayName: CS-6OAK
Description: Six of the same digit anywhere in the serial, with at least one separated from the others (no run of 6+). Grouped version is CS-Sextup (CS-400).  |  Green Guide: CS-430 (CS-6OAK)
BookRef: CS-430
Tier: 3
