--[[
Pattern: ESS_CS_DUAL_REPEATER_BOOKEND
DisplayName: CS-Dual Repeater Bookend
Description: First two digits repeat at the end in the same order (e.g., 12xxxx12). Both bookend digits must be different — if they are the same (11...11) that is CS-960.  |  Green Guide: CS-980 (CS-Dual Repeater Bookend)
BookRef: CS-980
Tier: 7
