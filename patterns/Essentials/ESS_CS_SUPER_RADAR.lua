--[[
Pattern: ESS_CS_SUPER_RADAR
DisplayName: CS-Super Radar
Description: A CS-Sextup (6 consecutive identical digits) wrapped by a CS-Pair (same digit at both ends). Structure: ABBBBBBA where A ≠ B.  |  Green Guide: CS-1260 (CS-Super Radar)
BookRef: CS-1260
Tier: 2
